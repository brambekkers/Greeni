  ...
  <Card
    ...
    <template #content>
      ...
      <VueTyping
        ...
        caret="" />
      <VueTyping
        :sentences="[`. I'm your AI assistant. Nice to meet you!`]"
        class="inline"
        :writeDelay="2400"
        :maxTypeSpeed="10"
        caret="" />
      ...
      <Button
        v-if="showButtons"
        label="Sure"
        class="!w-full mb-2 !bg-[#005e5d] !border-[#005e5d] !text-white"
        @click="$emit('open')" />
      <Button
        v-if="showButtons"
        label="No, thank you"
        class="!w-full !bg-[#edf7f7] !text-[#005e5d]"
        @click="status = 'leave'" />
    </template>
  </Card>
</template>
